...
var Pr = (l) => l.indexOf("bottom") !== -1;
var Yr = (l) => l.indexOf("left") !== -1;
var zl = (l) => l.indexOf("right") !== -1;
var Br = (l) => l.indexOf("top") !== -1;
var Nl = (l) => l.indexOf("fit") !== -1;
var Ll = (l) => l.indexOf("overlap") !== -1;
var jr = (l) => l.indexOf("center") !== -1;
function Zr(l, e) {
  let t = 0;
...
function xr(l, e, t) {
  ...
  const d = () => u("change", { value: n, input: true }), h = () => u("change", { value: n });
  return l.$$set = (m) => {
...
function ha(l, e, t) {
  ...
  const r = He(), { move: c, keydown: u, init: f, navigate: d } = oa(), h = () => {
    var _a2;
    return r("select", { id: (_a2 = s[a]) == null ? void 0 : _a2.id });
  };
  ht(() => {
...
function Ta(l, e, t) {
  ...
  const T = () => w("change", { value: n, input: true }), W = () => w("change", { value: n });
  function M() {
  ...
  const P = () => w("change", { value: n, input: true }), X = () => w("change", { value: n });
  function A() {
    n = this.value, t(0, n);
  }
  function B(L) {
  ...
  const V = () => w("change", { value: n, input: true }), fe = () => w("change", { value: n });
  return l.$$set = (L) => {
...
function Na(l, e, t) {
  ...
  const h = () => n("shift", { diff: -1, type: a }), m = () => n("shift", { diff: 1, type: a });
  return l.$$set = (_) => {
...
function Aa(l, e, t) {
  ...
  let d, h;
  const m = (T, W, M) => new Date(T.getFullYear(), T.getMonth() + (W || 0), T.getDate() + (M || 0));
  let _ = a !== "normal";
  function w() {
...
function lc(l, e, t) {
  ...
  const w = (T) => m(T.detail), b = (T) => d(T, -1), p = (T) => d(T, null), z = (T) => d(T, /* @__PURE__ */ new Date());
  return l.$$set = (T) => {
...
function oc(l, e, t) {
  ...
  const f = (h) => c(h.detail), d = (h) => u(h.detail);
  return l.$$set = (h) => {
...
function cc(l, e, t) {
  ...
  const X = (B) => M(B.detail.value), A = () => t(11, T = true);
  return l.$$set = (B) => {
...
function Ct(l, e) {
  var _a2, _b, _c2, _d2;
  const t = Fn(), n = (e == null ? void 0 : e.weekStartsOn) ?? ((_b = (_a2 = e == null ? void 0 : e.locale) == null ? void 0 : _a2.options) == null ? void 0 : _b.weekStartsOn) ?? t.weekStartsOn ?? ((_d2 = (_c2 = t.locale) == null ? void 0 : _c2.options) == null ? void 0 : _d2.weekStartsOn) ?? 0, i = he(l), s = i.getDay(), o = (s < n ? 7 : 0) + s - n;
...
function ru(l, e, t) {
  const n = Oo(l, e) / Eo;
  return gl(t == null ? void 0 : t.roundingMethod)(n);
}
function au(l, e, t) {
  const n = Oo(l, e) / Qc;
  return gl(t == null ? void 0 : t.roundingMethod)(n);
...
function mu(l, e) {
  const t = e == null ? void 0 : e.weekStartsOn, n = he(l), i = n.getDay(), s = (i < t ? -7 : 0) + 6 - (i - t);
...
var gu = (l, e, t) => {
  let n;
  const i = _u[l];
  return typeof i == "string" ? n = i : e === 1 ? n = i.one : n = i.other.replace("{{count}}", e.toString()), (t == null ? void 0 : t.addSuffix) ? t.comparison && t.comparison > 0 ? "in " + n : n + " ago" : n;
};
function jn(l) {
  return function() {
...
function on(l) {
  return (e, t) => {
    ...
    if (n === "formatting" && l.formattingValues) {
      const o = l.defaultFormattingWidth || l.defaultWidth, a = (t == null ? void 0 : t.width) ? String(t.width) : o;
      i = l.formattingValues[a] || l.formattingValues[o];
    } else {
      const o = l.defaultWidth, a = (t == null ? void 0 : t.width) ? String(t.width) : l.defaultWidth;
...
var zu = { ordinalNumber: Hu, era: on({ values: Su, defaultWidth: "wide" }), quarter: on({ values: Mu, defaultWidth: "wide", argumentCallback: (l) => l - 1 }), month: on({ values: Tu, defaultWidth: "wide" }), day: on({ values: Cu, defaultWidth: "wide" }), dayPeriod: on({ values: Du, defaultWidth: "wide", formattingValues: Wu, defaultFormattingWidth: "wide" }) };
function rn(l) {
  return function(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
...
var Gu = { ordinalNumber: Eu({ matchPattern: Iu, parsePattern: Ru, valueCallback: (l) => parseInt(l, 10) }), era: rn({ matchPatterns: Ou, defaultMatchWidth: "wide", parsePatterns: Au, defaultParseWidth: "any" }), quarter: rn({ matchPatterns: Fu, defaultMatchWidth: "wide", parsePatterns: Pu, defaultParseWidth: "any", valueCallback: (l) => l + 1 }), month: rn({ matchPatterns: Yu, defaultMatchWidth: "wide", parsePatterns: Bu, defaultParseWidth: "any" }), day: rn({ matchPatterns: ju, defaultMatchWidth: "wide", parsePatterns: Zu, defaultParseWidth: "any" }), dayPeriod: rn({ matchPatterns: qu, defaultMatchWidth: "any", parsePatterns: Ku, defaultParseWidth: "any" }) };
...
function Bo(l, e) {
  var _a2, _b, _c2, _d2;
  const t = he(l), n = t.getFullYear(), i = Fn(), s = (e == null ? void 0 : e.firstWeekContainsDate) ?? ((_b = (_a2 = e == null ? void 0 : e.locale) == null ? void 0 : _a2.options) == null ? void 0 : _b.firstWeekContainsDate) ?? i.firstWeekContainsDate ?? ((_d2 = (_c2 = i.locale) == null ? void 0 : _c2.options) == null ? void 0 : _d2.firstWeekContainsDate) ?? 1, o = lt(l, 0);
...
function Ju(l, e) {
  var _a2, _b, _c2, _d2;
  const t = Fn(), n = (e == null ? void 0 : e.firstWeekContainsDate) ?? ((_b = (_a2 = e == null ? void 0 : e.locale) == null ? void 0 : _a2.options) == null ? void 0 : _b.firstWeekContainsDate) ?? t.firstWeekContainsDate ?? ((_d2 = (_c2 = t.locale) == null ? void 0 : _c2.options) == null ? void 0 : _d2.firstWeekContainsDate) ?? 1, i = Bo(l, e), s = lt(l, 0);
...
function xn(l, e, t) {
  ...
  const n = Fn(), i = (t == null ? void 0 : t.locale) ?? n.locale ?? Xu, s = (t == null ? void 0 : t.firstWeekContainsDate) ?? ((_b = (_a2 = t == null ? void 0 : t.locale) == null ? void 0 : _a2.options) == null ? void 0 : _b.firstWeekContainsDate) ?? n.firstWeekContainsDate ?? ((_d2 = (_c2 = n.locale) == null ? void 0 : _c2.options) == null ? void 0 : _d2.firstWeekContainsDate) ?? 1, o = (t == null ? void 0 : t.weekStartsOn) ?? ((_f2 = (_e = t == null ? void 0 : t.locale) == null ? void 0 : _e.options) == null ? void 0 : _f2.weekStartsOn) ?? n.weekStartsOn ?? ((_h2 = (_g = n.locale) == null ? void 0 : _g.options) == null ? void 0 : _h2.weekStartsOn) ?? 0, a = he(l);
  ...
  return r.map((u) => {
    ...
    const f = u.value;
    (!(t == null ? void 0 : t.useAdditionalWeekYearTokens) && sf(f) || !(t == null ? void 0 : t.useAdditionalDayOfYearTokens) && lf(f)) && of(f, e, String(l));
    const d = ui[f[0]];
...
function Uo(l, e) {
  var _a2;
  l.open && ((_a2 = l.data) == null ? void 0 : _a2.forEach((t) => {
    t.$x += e, Uo(t, e);
  }));
}
function el(l, e, t, n) {
...
function Jo(l, e, t, n) {
  ...
  (_a2 = l.data) == null ? void 0 : _a2.forEach((o) => {
...
function pl(l, e) {
  ...
  const n = { data: t, ...l };
  if ((_a2 = n.data) == null ? void 0 : _a2.length) n.data.forEach((i) => {
...
var Of = class extends Bc {
  ...
  copy(e, t, n) {
    ...
    let s = [[e.id, i.id]];
    return (_a2 = e.data) == null ? void 0 : _a2.forEach((o, a) => {
...
var Uf = class extends jc {
  constructor(e) {
    ...
    this._router = new Zc(super.setState.bind(this), [{ in: ["tasks", "start", "end", "scales"], out: ["_start", "_end"], exec: (i) => {
    ...
    } }, { in: ["_start", "_end", "cellWidth", "scaleHeight", "scales", "lengthUnit"], out: ["_scales"], exec: (i) => {
    ...
    } }, { in: ["_scales", "tasks", "cellHeight", "baselines"], out: ["_tasks"], exec: (i) => {
    ...
    } }, { in: ["_tasks", "links", "cellHeight"], out: ["_links"], exec: (i) => {
    ...
    } }, { in: ["start", "end"], out: ["cellWidth"], exec: (i) => {
      const { _cellWidth: s, cellWidth: o } = this.getState();
      s != o && this.setState({ cellWidth: s }, i);
    } }], { tasks: (i) => new Of(i), links: (i) => new ci(i), columns: (i) => Kf(i) });
    ...
    t.on("move-task", (i) => {
      ...
      if (r && (o.start && (o.start = d(o.start, r)), o.end && (o.end = d(o.end, r))), o.start && o.end) {
        if ((!Kt(o.start, m.start) || !Kt(o.end, m.end)) && m.type == "summary" && ((_a2 = m.data) == null ? void 0 : _a2.length)) {
      ...
      if (r ? (h = s.byId(r), c == "child" ? (d = h, u.parent = d.id) : (h.parent !== null && (d = s.byId(h.parent), u.parent = d.id), f = s.getIndexById(r), c == "after" && (f += 1))) : u.parent && (d = s.byId(u.parent)), !u.start) {
        if (d == null ? void 0 : d.start) u.start = new Date(d.start.valueOf());
  ...
  resetSummaryDates(e, t) {
    ...
    if ((s == null ? void 0 : s.length) > 1 || (s == null ? void 0 : s.length) && s[0].type !== "milestone") {
  ...
  moveSummaryKids(e, t, n) {
    ...
    e.data.forEach((s) => {
      ...
      o.type !== "milestone" && (o.end = t(s.end)), delete o.id, this.in.exec("update-task", { id: s.id, task: o, eventSource: n }), ((_a2 = s.data) == null ? void 0 : _a2.length) && this.moveSummaryKids(s, t, n);
    });
  }
};
function bi(l, e, t, n) {
  ...
  function w(M) {
    ...
    if (n) {
      ...
      if (V && V !== t) {
        ...
        (r == null ? void 0 : r.after) == fe || (r == null ? void 0 : r.before) == fe ? r = null : G ? r = { id: i, after: fe } : pe && (r = { id: i, before: fe });
      }
    }
  }
  function b(M) {
...
var Dd = class extends dd {
  constructor(e) {
    ...
    this._router = new hd(
      ...
      [
        ...
        { in: ["columns", "sizes", "_skin"], out: ["_columns", "_sizes"], exec: (i) => {
      ...
      {
        // data initializers
        data: (i) => this._branches ? this.normalizeTreeRows(i) : this.normalizeRows(i),
    ...
    n.on("close-editor", (_ref36) => {
      ...
      switch (i) {
        case "arrowup": {
          ...
          if (!a) {
            s.preventDefault();
            const c = o ? (_a2 = this.getPrevRow(o)) == null ? void 0 : _a2.id : (_b = r[r.length - 1]) == null ? void 0 : _b.id;
        ...
        case "arrowdown": {
          ...
          if (!a) {
            s.preventDefault();
            const c = o ? (_c2 = this.getNextRow(o)) == null ? void 0 : _c2.id : (_d2 = r[0]) == null ? void 0 : _d2.id;
            c && this.in.exec("select-row", { id: c, show: true });
          }
          break;
        }
  ...
  toggleBranch(e, t, n) {
    ...
    e !== 0 && (i.open = t), n && ((_a2 = i.data) == null ? void 0 : _a2.length) && i.data.forEach((s) => {
      this.toggleKids(s, t, n);
    });
  }
  toggleKids(e, t, n) {
    var _a2;
    e.open = t, n && ((_a2 = e.data) == null ? void 0 : _a2.length) && e.data.forEach((i) => {
  ...
  normalizeTreeRows(e, t, n) {
    return e.forEach((i) => {
      var _a2;
      i.id || (i.id = qn()), i.$level = t || 0, i.$parent = n || 0, this._branches[i.id] = i, ((_a2 = i.data) == null ? void 0 : _a2.length) && (i.$count = i.data.length, this.normalizeTreeRows(i.data, i.$level + 1, i.id));
    }), e;
  }
  sortTree(e, t) {
  ...
  flattenRows(e, t) {
    ...
    return e.forEach((i) => {
      var _a2;
      n.push(i), ((_a2 = i.data) == null ? void 0 : _a2.length) && i.open !== false && this.flattenRows(i.data, n);
    }), n;
  }
...
var sh = class extends ee {
  constructor(e) {
    super(), $(this, e, ih, lh, x, { actions: 4, editor: 5 });
  }
};
var oh = (l) => ({ option: l & /*option*/
131072 });
var ji = (l) => ({ option: (
  /*option*/
  l[17]
...
function dh(l, e, t) {
  ...
  const w = () => c.findIndex((T) => T.id === o.value);
  function b(T) {
    be[T ? "unshift" : "push"](() => {
      _ = T, t(4, _);
    });
...
var ph = class extends ee {
  constructor(e) {
    super(), $(this, e, kh, bh, x, { actions: 0, editor: 1 });
  }
};
var yh = (l) => ({ option: l & /*option*/
131072 });
var Zi = (l) => ({ option: (
  /*option*/
  l[17]
...
function Nh(l, e, t) {
  ...
  const m = () => a.options.findIndex((T) => T.id === a.value);
  let _;
  ht(() => {
...
function Ui(l, e) {
  ...
  function c(u, f) {
    ...
    return (
      ...
      u[92].collapsed ? 0 : (
        /*$editor*/
        ((_a2 = u[16]) == null ? void 0 : _a2.id) === /*row*/
        u[89].id && /*$editor*/
        u[16].column == /*col*/
        u[92].id ? 1 : (
          /*col*/
...
function Zh(l, e, t) {
  ...
  const Tr = () => t(27, ln = null), Cr = () => t(27, ln = true), Dr = (N) => w.exec("hotkey", N);
  return l.$$set = (N) => {
    ...
    24) {
      ...
      _e = we == null ? void 0 : we.row.start;
    }
...
function om(l, e, t) {
  ...
  function p() {
    ...
    t(3, d = A.x || d), t(4, h = A.y || h), A.index, t(5, m = (A == null ? void 0 : A.width) || m);
  }
  c && c(p), ht(p);
  function z() {
    t(7, w = false);
...
var Dm = (l) => l.$reorder ? "wx-reorder-task" : "";
var Wm = (l) => "wx-text-" + l.align;
function Hm(l, e, t) {
  ...
  function J(Z) {
    ...
    if (ct) {
      if (ut == "after") {
        ...
        ((_a2 = zt.data) == null ? void 0 : _a2.length) && zt.open && (ut = "before", _t = zt.data[0].id);
      }
      Je = { id: ae, [ut]: _t };
    } else Je = null;
...
function C1(l, e, t) {
  ...
  return l.$$set = (M) => {
    ...
    4096 && t(3, n = (s == null ? void 0 : s.type) === "milestone"), l.$$.dirty & /*$task*/
    4096 && t(2, i = (s == null ? void 0 : s.type) === "summary");
  }, [a, r, i, n, o, c, f, d, h, m, _, b, s, p, z, T, W];
}
var D1 = class extends ee {
  constructor(e) {
...
function R1(l, e, t) {
  ...
  function ye(U, ge) {
    var _a2;
    let Me;
    return ge.every((Fe) => Fe.width && !Fe.flexgrow) ? Me = ge.reduce((Fe, Je) => (Fe += parseInt(Je.width), Fe), 0) : Me = 440, t(9, P = Me), U && (Me = parseInt((_a2 = ge.find((Fe) => Fe.id === "action")) == null ? void 0 : _a2.width) || 50), Me;
  }
  function ve() {
...
function O_(l, e, t) {
  let n, i = I, s = () => (i(), i = Lt(w, (p) => t(8, n = p)), w), o, a = I, r = () => (a(), a = Lt(m, (p) => t(6, o = p)), m);
  ...
  let h, m, _, w;
  function b() {
    t(3, u = u.map((p) => ({ ...p, disabled: false }))), (o == null ? void 0 : o.length) ? t(1, _ = u.map((p) => {
      if (!p.check) return p;
...
function F_(l, e, t) {
  let n, i, s = I, o = () => (s(), s = Lt(fe, (ie) => t(22, i = ie)), fe), a, r = I, c = () => (r(), r = Lt(V, (ie) => t(23, a = ie)), V), u, f = I, d = () => (f(), f = Lt(B, (ie) => t(24, u = ie)), B), h, m = I, _ = () => (m(), m = Lt(L, (ie) => t(15, h = ie)), L);
  l.$$.on_destroy.push(() => s()), l.$$.on_destroy.push(() => r()), l.$$.on_destroy.push(() => f()), l.$$.on_destroy.push(() => m());
  let { $$slots: w = {}, $$scope: b } = e, { options: p = [...id] } = e, { api: z = null } = e, { resolver: T = null } = e, { filter: W = null } = e, { handler: M = () => {
  } } = e, { at: C = "point" } = e;
  const P = He();
...
function GanttComponent(props) {
  ...
  (0, import_react.useImperativeHandle)(props.api, () => ({
    getState: () => ws2.api.getState(),
    getReactiveState: () => ws2.api.getReactiveState(),
    getStores: () => ws2.api.getStores(),
    exec: (name, data) => ws2.api.exec(name, data),
    setNext: (ev) => ws2.api.setNext(ev),
    intercept: (name, data) => ws2.api.intercept(name, data),
    on: (name, handler) => ws2.api.on(name, handler),
    detach: (name, handler) => ws2.api.detach(name, handler),
    getTask: (id2) => ws2.api.getTask(id2)
  }));
