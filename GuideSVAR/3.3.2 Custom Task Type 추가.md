...
타스크 유형은 [`taskTypes`](https://docs.svar.dev/react/gantt/api/properties/taskTypes) 속성을 통해 추가할 수 있습니다. 기본 유형은 다음과 같습니다:

- Task
- Milestone
- Summary task

각 유형에 대한 설명은 여기서 확인할 수 있습니다: [Task types](https://docs.svar.dev/react/gantt/overview#task-types).

## 사용자 지정 타입 추가

새로운 타스크 유형을 추가하려면, [`taskTypes`](https://docs.svar.dev/react/gantt/api/properties/taskTypes) 배열에 새로운 객체를 추가합니다:
...
또한, 각 타입의 모양을 사용자 지정할 수 있습니다. 각 타입의 ID를 사용하여 각 타스크 타입에 대한 CSS 규칙을 추가하는 방법입니다.
